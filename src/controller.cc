...
Controller::Controller() : last_dt(0) {
  ...
  aparams.n_foods = N_FOOD;
  aparams.n_fear_robots = ROBOT_FEAR;
  aparams.n_aggressive_robots = ROBOT_AGGRESSIVE;
  aparams.n_explore_robots = ROBOT_EXPLORE;
  aparams.n_love_robots = ROBOT_LOVE;
