 ...
 *
 * Since this is base a food class, many of its methods are intuitively
 * `virtual`.
 */
class ArenaMobileEntity : public ArenaEntity {
 public:
  ...
  /**
   * @brief Getter for the speed of the entity
   *
   * @param[out] returns the speed of the entity
   */
  virtual double get_speed() { return speed_; }

  /**
   * @brief Setter for the speed of the entity
   *
   * @param[in] sp changes the speed of the entity to sp
   */
   ...
   *
   * @param[out] returns the sensor touch *
  */
