...
struct arena_params {
  ...
  size_t n_foods{N_FOOD};
  size_t n_fear_robots{ROBOT_FEAR};
  size_t n_aggressive_robots{ROBOT_AGGRESSIVE};
  size_t n_explore_robots{ROBOT_EXPLORE};
  size_t n_love_robots{ROBOT_LOVE};
