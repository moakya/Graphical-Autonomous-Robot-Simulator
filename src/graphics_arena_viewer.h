...
class GraphicsArenaViewer : public GraphicsApp {
 public:
   ...
   *
   * This will reset the game and start a new random game.
   */
   ...
   *
   * This will turn the food in the arena on or off.
   */
  void OnFoodTogglePressed();
 ...
 private:
   ...
   */
  void DrawRobot(NVGcontext *ctx, const std::vector<class Robot *> robot_vec);
